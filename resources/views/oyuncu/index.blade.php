                    ...
                    <div class="nano">
                        <div class="nano-content">
                            ...
                            <div class="nk-news-box-item nk-news-box-item-active">
                                ...
                                <h3 class="nk-news-box-item-title">{{$haber->baslik}}</h3>
                                ...
                                <div class="nk-news-box-item-text">
                                    ...
                                    {{ __('anasayfa.Read More') }}
                                </div>
                                <a href="blog-article.html" class="nk-news-box-item-url"></a>
                                <div class="nk-news-box-item-date"><span class="fa fa-calendar"></span>
                                    {{ app()->setLocale('tr') }}
                                    {{ $haber->created_at->diffForHumans() }}
                                </div>
                            </div>
                        </div>
                    </div>
